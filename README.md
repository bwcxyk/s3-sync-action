  ...
  deploy:
    ...
    - uses: bwcxyk/s3-sync-action@1.0.0
      ...
      env:
        ...
        AWS_SESSION_TOKEN: ${{ AWS_SESSION_TOKEN }} # optional: when using ad hoc temporary credentials using AWS STS
...
| `AWS_SESSION_TOKEN` | Your AWS Session Token. [More info here.](https://docs.aws.amazon.com/general/latest/gr/managing-aws-access-keys.html) | `secret env` | **No** | N/A |
